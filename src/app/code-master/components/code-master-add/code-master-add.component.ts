...
@Component({
    selector: 'ngx-code-master-add',
    templateUrl: './code-master-add.component.html',
    styleUrls: ['./code-master-add.component.scss'],
})
export class CodeMasterAddComponent implements OnInit {
