...
@Component({
  selector: 'ngx-se-customer-other-information',
  templateUrl: './other-information-dialog.component.html',
  styleUrls: ['./other-information-dialog.component.scss']
})
export class OtherInformationEditComponent implements OnInit {
  ...
  constructor(
    ...
    protected dialogRef: NbDialogRef<OtherInformationEditComponent>,
  ) { }
  ngOnInit() {
    this.createForm();
  }
  createForm = () => {
    this.addSecondaryCustomerForm = this.fb.group({
      ...
      Validators.required],
      businessType: [
        this.secondarycustomer ? this.secondarycustomer.businessType : '',
      Validators.required],
      ...
      vatregistrationId: [this.secondarycustomer ? this.secondarycustomer.vatregistrationId : '',
      Validators.required],
      ...
      gender: [
        this.secondarycustomer ? this.secondarycustomer.gender : null,
        Validators.required],
      givenName: [
        this.secondarycustomer ? this.secondarycustomer.givenName : null,
        Validators.required],
      surname: [
        this.secondarycustomer ? this.secondarycustomer.surname : null,
        Validators.required],
      identityCard: [
        this.secondarycustomer ? this.secondarycustomer.identityCard : null,
        Validators.required],
      ...
      Validators.required],
      anchorAccount: [this.secondarycustomer ? this.secondarycustomer.anchorAccount : null,
      Validators.required],
      ...
      Validators.required],
      bankBrandName: [
        this.secondarycustomer ? this.secondarycustomer.bankBrandName : null,
        Validators.required],
      bankBrandCode: [
        this.secondarycustomer ? this.secondarycustomer.bankBrandCode : null,
        Validators.required],
      identityCardDate: [
        this.secondarycustomer ? this.secondarycustomer.identityCardDate : null,
      Validators.required],
      identityCardPlace: [
        this.secondarycustomer ? this.secondarycustomer.identityCardPlace : null,
      Validators.required],
      source: [this.secondarycustomer ? this.secondarycustomer.source : null,
      Validators.required],
      createdBy: [
        this.secondarycustomer ? this.secondarycustomer.createdBy : null,
      Validators.required],
      createdDateTime: [
        this.secondarycustomer ? this.secondarycustomer.createdDateTime : null,
      Validators.required],
      lastUpdatedBy: [
        this.secondarycustomer ? this.secondarycustomer.lastUpdatedBy : null,
      Validators.required],
      rowVersion: [
        this.secondarycustomer ? this.secondarycustomer.rowVersion : null,
      Validators.required],
      lastUpdatedDateTime: [
        this.secondarycustomer ? this.secondarycustomer.lastUpdatedDateTime : null,
      Validators.required],
      ...
      secondaryCustomerGroupDescription: [
        ...
        Validators.required],
      tax: [this.secondarycustomer ? this.secondarycustomer.tax : null,
      Validators.required],
      attribute7: [this.secondarycustomer ? this.secondarycustomer.attribute7 : null,
      Validators.required],
      rowNumber: [this.secondarycustomer ? this.secondarycustomer.rowNumber : null,
      Validators.required],
