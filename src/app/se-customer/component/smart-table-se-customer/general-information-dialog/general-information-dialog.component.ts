...
@Component({
  selector: 'ngx-se-customer-general-information',
  templateUrl: './general-information-dialog.component.html',
  styleUrls: ['./general-information-dialog.component.scss']
})
export class GeneralInformationEditComponent implements OnInit {
  public addSecondaryCustomerForm: FormGroup;
  public secondarycustomer: SecondaryCustomer;
  @Output() response: EventEmitter<any> = new EventEmitter();
  constructor(
    private fb: FormBuilder,
    protected dialogRef: NbDialogRef<GeneralInformationEditComponent>
  ) { }
  ...
  createForm = () => {
    this.addSecondaryCustomerForm = this.fb.group({
      ...
      billToSecondaryCustomerName: [
        this.secondarycustomer ? this.secondarycustomer.billToSecondaryCustomerName : '', Validators.required],
      vatregistrationId: [
  ...
  submit(item) {
    ...
    //   }
    //     this.close();
    this.dialogRef.close(item); // đoạn này dùng để truyền data sang cho form chính
  }
}
