...
@Component({
  selector: 'ngx-se-customer-properties',
...
export class PropertiesEditComponent implements OnInit {
  ...
  constructor(
    ...
    protected dialogRef: NbDialogRef<PropertiesEditComponent>
  ) { }
  ngOnInit() {
    this.createForm();
  }
  createForm = () => {
    this.addSecondaryCustomerForm = this.fb.group({
      ...
      Validators.required],
      pricePaymentTermCode: [this.secondarycustomer ? this.secondarycustomer.pricePaymentTermCode : '',
      Validators.required],
      ...
      legalOwnerName: [this.secondarycustomer ? this.secondarycustomer.legalOwnerName : null,
      Validators.required],
      ...
      Validators.required],
      defaultDeliveryDay: [this.secondarycustomer ? this.secondarycustomer.defaultDeliveryDay : null,
      Validators.required],
      contractExpiredDate: [this.secondarycustomer ? this.secondarycustomer.contractExpiredDate : null,
      Validators.required],
      ...
      pricePaymentTerm: [this.secondarycustomer ? this.secondarycustomer.pricePaymentTerm : null,
      Validators.required],
