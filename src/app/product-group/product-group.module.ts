...
import { ProductGroupAddComponent } from './components/product-group-add/product-group-add.component';
import { ProductGroupViewComponent } from './components/product-group-view/product-group-view.component';
